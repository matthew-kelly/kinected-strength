...
const specialtyProgramFields = `
  ...
  "slug": slug.current
`;
export const allSpecialtyProgramsQuery = `
*[_type == "specialtyProgram"] | order(publishedDate desc) {
  ${specialtyProgramFields}
}
`;
export const specialtyProgramsSlugsQuery = `
*[_type == "specialtyProgram" && defined(slug.current)][].slug.current
`;
export const specialtyProgramQuery = `
*[_type == "specialtyProgram" && slug.current == $slug] | order(publishedDate desc)[0] {
  ${specialtyProgramFields},
  body
}
`;
