...
import { motion, useScroll, useAnimation, LayoutGroup } from "framer-motion";
...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="bg-primary-dark relative flex flex-col">
        <div className="relative flex flex-col">
          <LayoutGroup>
            <motion.div
              layout
              className="self-center w-full mt-32 mb-48 z-10"
              animate={controls}
              variants={bannerVariants}
              initial="initial"
            >
              <Image
                src="/temp/tempbanner-horiz.jpg"
                height={735}
                width={1600}
                layout="responsive"
                priority
            ...
            {/* FIXME: proper responsive initial height */}
            <motion.div
              // ref={scrollRef}
              className="z-20 absolute left-0 right-0" // bottom-12
              animate={controls}
            ...
            >
              <motion.svg
                height="200"
                viewBox="0 0 192 45"
                className="z-20 fill-primary-light m-auto"
                animate={controls}
        ...
        <Image src="/temp/samplebanner.png" height={"900"} width={"1600"} />
      </div>
