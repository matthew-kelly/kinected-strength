  ...
  return (
    <>
      ...
      <ArticleContainer>
        ...
        <header className="flex flex-col relative mt-4 md:mt-8 border-b-primary-dark border-b-2 pb-2 mb-4 md:mb-8">
          <h1 className="md:mb-4 mb-2 md:text-5xl text-3xl">{program.title}</h1>
        ...
        <section className="prose prose-sm first:prose-headings:mt-0 prose-headings:mt-6 prose-headings:mb-4 prose-headings:text-primary-dark prose-strong:text-primary-dark prose-img:my-4 prose-p:mt-0 prose-p:mb-4 prose-ul:mt-0 prose-ul:mb-4 prose-li:marker:text-secondary-dark prose-li:pl-0 mx-auto w-full">
          <PortableText
            value={program.body}
            components={{
              types: {
